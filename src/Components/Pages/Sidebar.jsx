...
{context.toggleSidebar?( <Tooltip  title="Employee Activity">
        <li>
          <Button
            style={{ color: "#555151" }}
            className={`custom-button ${
...
{context.toggleSidebar?(<Tooltip  title="Transefer">
        <li>
          <Button
            style={{ color: "#555151" }}
            className={`custom-button ${
    ...
    {context.toggleSidebar?(<Tooltip  title="Sales">
        ...
        {context.toggleSidebar?(<Tooltip  title="employee Conncern">
